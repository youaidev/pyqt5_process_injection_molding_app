...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\GitHub\pyqt5_process_injection_molding_app'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\GitHub\pyqt5_process_injection_molding_app\Scripts\deactivate.nu'
